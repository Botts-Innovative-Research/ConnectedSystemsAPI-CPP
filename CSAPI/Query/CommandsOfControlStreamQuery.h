...
namespace ConnectedSystemsAPI::Query {
	...
	public:
		...
		/// </summary>
		CommandsOfControlStreamQuery& setIssueTime(DataModels::TimeExtent issueTime) {
		...
		/// Intervals may be bounded or half-bounded (double-dots at start or end).
		/// </summary>
		CommandsOfControlStreamQuery& setExecutionTime(DataModels::TimeExtent executionTime) {
		...
		/// </summary>
		CommandsOfControlStreamQuery& setStatusCode(const std::string& statusCode) {
		...
		/// </summary>
		CommandsOfControlStreamQuery& setSender(const std::string& sender) {
		...
		/// </summary>
		CommandsOfControlStreamQuery& setControlStream(std::vector<std::string>& controlStream) {
		...
		/// </summary>
		CommandsOfControlStreamQuery& setFoi(const std::string& foi) {
		...
		/// </summary>
		CommandsOfControlStreamQuery& setControlledProperty(const std::string& controlledProperty) {
		...
		/// Default: 100
		/// </summary>
		CommandsOfControlStreamQuery& setLimit(int limit) {
